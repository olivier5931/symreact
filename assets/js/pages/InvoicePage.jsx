	...
	const handleSubmit = async event => {
		...
		try {
			if (editing) {
				...
				console.log("La facture a bien été modifiée");
			} else {
				await InvoicesAPI.create(invoice);
				console.log("La facture a bien été enregistrée");
				history.replace("/invoices");
			}
		} catch ({ response }) {
		...
		<>
			{(editing && <h1>Modification d'une facture</h1>) || (
				...
				<form onSubmit={handleSubmit}>
					...
					<Select	name="customer"	label="Client" value={invoice.customer}
